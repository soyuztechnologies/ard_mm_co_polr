		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bestellungen anzeigen (ARD)",
									"targetURL": "#ardmmcopolrardmmcopolr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ardmmcopolrardmmcopolr-display": {
								"semanticObject": "ardmmcopolrardmmcopolr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ard.mm.co.polr.ardmmcopolr",
									"url": sap.ui.require.toUrl("ard/mm/co/polr/ardmmcopolr")
								}
							}
						}
					}
